...
function setDatatable() {
  ...
  table = studentsList.DataTable({
    ...
    buttons: [
      ...
      },
      {
        extend: "pdfHtml5",
        filename: "Data Siswa",
        title: "Daftar Penilaian Afektif Siswa",
        footer: true,
        exportOptions: {
    ...
    aoColumns: [
      ...
      { data: "kelas", name: "kelas", title: "Kelas" },
      {
        data: "jenis_kelamin",
        name: "Jenis Kelamin",
        title: "Jenis Kelamin",
      ...
      { data: "classroom_name", name: "Ruang Kelas", title: "Ruang Kelas" },
      {
        data: null,
        name: "nilai",
        title: "Nilai",
        render: function (data, row, type, meta) {
          ...
          if (readyTo == "input") {
            ...
            result +=
              `<select id="` +
              data.id +
              `" class="w3-select w3-border edit_nilai">
              <option id="K" ` +
              selectedK +
              `>K</option>
                                        <option id="A" ` +
  ...
  $("#students-list tbody").on("click", ".view_data", function () {
    let id = $(this).attr("id");
  ...
  $("#students-list tbody").on("click", ".edit_data", function () {
    hAdd.hide();
    hEdit.show();
    resetWajib();
    let id = $(this).attr("id");
  ...
  $("#students-list tbody").on("click", ".hapus_data", function () {
    Swal.fire({
      title: "Are you sure?",
          ...
          success: function (response) {
            if (response.code == 200) {
              Swal.fire({
                ...
                studentsList.DataTable().ajax.reload(null, false);
              });
            } else {
              Swal.fire({
                icon: response.status,
  ...
  $("#students-list tbody").on("change", ".edit_nilai", function () {
    Swal.fire({
