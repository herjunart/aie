...
<head>
    <title><?= $lang_students_data; ?> | <?= $lang_app_name; ?></title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="w3-main" style="margin-left:200px;margin-top:40px;">
        ...
        <header class="w3-container">
            <h5 class="animate__animated animate__bounce" style="padding:30px 0 0 10px"><b><i class="fa fa-database"></i> <?= $lang_students_data; ?></b></h5>
        </header>
        ...
        <div class="w3-container">
            <table id="students-list" class="table table-striped table-bordered" width="100%"></table>
        </div>
